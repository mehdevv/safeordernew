    ...
    <div className="min-h-screen bg-background text-foreground antialiased">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="leading-tight">
              ...
              <span className="hidden text-[11px] font-medium text-sidebar-foreground/70 sm:block">{tc("brand.tagline")}</span>
            </div>
          </Link>

          <nav className="hidden items-center gap-8 md:flex" aria-label={t("nav.mainAria")}>
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            <Button asChild size="default" className="font-semibold shadow-sm">
              <Link href="/merchant/register">{t("nav.startFree")}</Link>
            </Button>
          </div>

          <div className="flex shrink-0 items-center gap-2 md:hidden">
            <Button variant="ghost" size="icon" className="text-sidebar-foreground hover:bg-sidebar-accent" onClick={() => setIsMenuOpen(o => !o)} aria-expanded={isMenuOpen} aria-label={tc("menu")}>
          ...
          <div className="border-t border-sidebar-border px-4 py-4 md:hidden">
            <div className="mx-auto flex max-w-7xl flex-col gap-1 sm:px-2">
              ...
              <Button asChild variant="secondary" className="mt-2 w-full font-semibold">
                <Link href="/merchant/register" onClick={() => setIsMenuOpen(false)}>{t("nav.startFree")}</Link>
              </Button>
              <div className="mt-4 flex w-full max-w-xs flex-col items-stretch gap-2 border-t border-sidebar-border pt-4">
                <span className="text-center text-[11px] font-semibold uppercase tracking-wider text-sidebar-foreground/60">{t("nav.language")}</span>
                <LanguageSwitch className="w-full [&>button]:min-w-0 [&>button]:flex-1" />
              </div>
            </div>
          </div>
        ) : null}
      ...
      <main>
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-6 sm:space-y-8">
              ...
              <motion.div variants={fadeIn} className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
                ...
                <Button asChild size="lg" variant="outline" className="w-full font-semibold sm:w-auto">
                  <a href="#features">{t("hero.ctaSafePay")}</a>
                </Button>
              </motion.div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.12 }} className="relative">
              <Card className="overflow-hidden border-border/80 p-0 shadow-md">
                <div className="border-b border-border/60 bg-muted/30 px-4 py-2.5">
                  <p className="text-center text-[11px] font-medium uppercase tracking-wider text-muted-foreground">{t("hero.mockupCaption")}</p>
                </div>
                <CardContent className="p-0">
                  <img src={heroMockup} alt={t("hero.mockupAlt")} className="w-full object-cover" loading="eager" />
                </CardContent>
              </Card>
                ...
                <Card className="border-border/80 shadow-md">
                  <CardContent className="flex items-center gap-4 p-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-success/15">
                      <span className="text-base font-bold text-success">{t("hero.floatValue")}</span>
                    </div>
                    <div className="min-w-0 text-start">
                      <p className="text-sm font-semibold leading-snug text-foreground">{t("hero.floatTitle")}</p>
                ...
                <Link href="/merchant/register" className="block h-full">
                  <Card className="group h-full border-border/80 transition-all hover:border-primary hover:shadow-md">
                    <CardHeader className="space-y-4">
                      ...
                      <CardTitle className="text-xl">{t("roles.merchantTitle")}</CardTitle>
                      <CardDescription className="text-sm leading-relaxed">
                        {t("roles.merchantDesc")}
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </Link>
                ...
                <Link href="/client/login" className="block h-full">
                  <Card className="group h-full border-border/80 transition-all hover:border-primary hover:shadow-md">
                    <CardHeader className="space-y-4">
                      ...
                      <CardTitle className="text-xl">{t("roles.clientTitle")}</CardTitle>
                      <CardDescription className="text-sm leading-relaxed">
                        {t("roles.clientDesc")}
                      </CardDescription>
                    </CardHeader>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35 }}>
                <Card className="relative h-full overflow-hidden border-border/80 shadow-sm">
                  ...
                  <CardHeader className="relative z-10 space-y-4 pb-2">
                    ...
                    <CardTitle className="text-xl tracking-tight">{t("features.safePayTitle")}</CardTitle>
                    <CardDescription>
                      {t("features.safePayDesc")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="relative z-10 space-y-2 pb-6">
                    <ul className="space-y-2 text-sm font-medium text-foreground">
                      <li className="flex items-center gap-2">
                        ...
                        {t("features.safePayLi1")}
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 shrink-0 text-primary" aria-hidden />
                        {t("features.safePayLi2")}
                      </li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35, delay: 0.06 }}>
                <Card className="relative h-full overflow-hidden border-border/80 shadow-sm">
                  ...
                  <CardHeader className="relative z-10 space-y-4 pb-2">
                    ...
                    <CardTitle className="text-xl tracking-tight">{t("features.trackTitle")}</CardTitle>
                    <CardDescription>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35, delay: 0.12 }}>
                <Card className="relative h-full overflow-hidden border-border/80 shadow-sm">
                  ...
                  <CardHeader className="relative z-10 space-y-4 pb-2">
                    ...
                    <CardTitle className="text-xl tracking-tight">{t("features.trustTitle")}</CardTitle>
                    <CardDescription>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35, delay: 0.18 }}>
                <Card className="relative h-full overflow-hidden border-border/80 shadow-sm">
                  ...
                  <CardHeader className="relative z-10 space-y-4 pb-2">
                    ...
                    <CardTitle className="text-xl tracking-tight">{t("features.iaTitle")}</CardTitle>
                    <CardDescription>
                      {t("features.iaDesc")}
                    </CardDescription>
                  </CardHeader>
        ...
        <section id="tarifs" className="border-y border-primary/20 bg-primary py-16 text-primary-foreground sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-10 max-w-2xl text-center sm:mb-12">
              ...
              <p className="mt-2 text-sm text-primary-foreground/80 sm:text-base">{t("stats.sub")}</p>
            </div>
            <div className="grid grid-cols-2 gap-8 text-center md:grid-cols-4 md:gap-10">
              {[
                { v: t("stats.r1v"), l: t("stats.r1l") },
                { v: t("stats.r2v"), l: t("stats.r2l") },
                { v: t("stats.r3v"), l: t("stats.r3l") },
                { v: t("stats.r4v"), l: t("stats.r4l") },
              ].map(row => (
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading title={t("journey.title")} description={t("journey.desc")} />
            <div className="relative flex flex-col items-stretch gap-6 md:flex-row md:justify-between md:gap-8">
              ...
              {[
                { step: "1", title: t("journey.s1t"), desc: t("journey.s1d") },
                { step: "2", title: t("journey.s2t"), desc: t("journey.s2d") },
                { step: "3", title: t("journey.s3t"), desc: t("journey.s3d") },
                { step: "4", title: t("journey.s4t"), desc: t("journey.s4d") },
              ].map(s => (
        ...
        <section className="border-y border-border bg-card py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <p className="mb-8 text-center text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("partners.title")}</p>
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-6 transition-opacity md:gap-x-16">
              {["Yalidine", "ZR Express", "Maystro", "World Express"].map(p => (
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading title={t("testimonials.title")} description={t("testimonials.desc")} />
            <div className="grid gap-6 md:grid-cols-2 md:gap-8">
              <Card className="border-border/80 shadow-sm">
                ...
                <CardContent className="flex items-center gap-4 pb-6">
                  ...
                  <div>
                    <p className="text-sm font-semibold">{t("testimonials.n1")}</p>
                    <p className="text-xs text-muted-foreground">{t("testimonials.r1")}</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-border/80 shadow-sm">
                ...
                <CardContent className="flex items-center gap-4 pb-6">
                  ...
                  <div>
                    <p className="text-sm font-semibold">{t("testimonials.n2")}</p>
                    <p className="text-xs text-muted-foreground">{t("testimonials.r2")}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="border-t border-border bg-muted/30 py-16 sm:py-20">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <SectionHeading title={t("faq.title")} description={t("faq.desc")} />
            <Accordion type="single" collapsible className="w-full space-y-3">
              <AccordionItem value="item-1" className="rounded-xl border border-border bg-card px-1 shadow-sm">
                <AccordionTrigger className="px-5 py-5 text-start text-base font-semibold hover:no-underline hover:text-primary">
                  {t("faq.q1")}
                </AccordionTrigger>
          ...
          <div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
            ...
            <div className="mt-8 flex justify-center">
              <Button asChild size="lg" className="bg-brand-mint px-8 font-semibold text-brand-mint-foreground shadow-lg hover:bg-primary-foreground hover:text-primary">
                <Link href="/merchant/register">{t("cta.button")}</Link>
              </Button>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-border/60 bg-[color:var(--safeorder-ink)] py-12 text-primary-foreground">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 grid gap-10 md:grid-cols-4 md:gap-8">
            ...
            <div>
              <h4 className="mb-3 text-xs font-semibold uppercase tracking-wider text-primary-foreground/50">{t("footer.linksTitle")}</h4>
            ...
            <div>
              <h4 className="mb-3 text-xs font-semibold uppercase tracking-wider text-primary-foreground/50">{t("footer.legalTitle")}</h4>
              <ul className="space-y-2.5 text-sm text-primary-foreground/70">
                <li>
